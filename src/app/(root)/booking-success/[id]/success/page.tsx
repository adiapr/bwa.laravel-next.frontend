...
import { Transaction } from "@/interfaces/transactrion";
import { useGetDetailTransactionQuery } from "@/services/trensaction.service";
    ...
    <main>
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center font-semibold leading-6 max-w-[200px] ">
            <Image
